          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-700">
                Bienvenido, {perfil?.nombre ?? user.user_metadata?.nombre ?? user.email}
              </span>
              <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Bienvenido a tu panel de usuario. Aquí puedes ver tu información registrada.
            </p>
          </div>
            ...
            <div className="max-w-xl mx-auto">
              <div className="bg-blue-50 rounded-lg p-6 shadow">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
                  ...
                  <div>
                    <span className="font-semibold">Correo:</span> {perfil.correo || user.email}
                  </div>
                  <div>
                    <span className="font-semibold">Rol:</span> {perfil.rol || '-'}
                  </div>
                  <div>
                    <span className="font-semibold">Tipo de persona:</span> {perfil.tipo_persona || '-'}
                  </div>
                  <div>
                    <span className="font-semibold">Cédula:</span> {perfil.cedula || '-'}
                  </div>
                  <div>
                    <span className="font-semibold">RUC:</span> {perfil.ruc || '-'}
                  </div>
                  <div>
